...
**/
void Voxelizer::getVoxels(const MObject& pMeshObj, const MBoundingBox& pBoundingBox, std::vector<MFloatPoint> &voxels, std::vector<glm::vec2> &uvs)
{
